...
A _transaction input_ is a pair of values (**h**, **i**), where:

 * **h** is the _hash_ of an existing transaction **t**; and
 * **i** is a non-negative integer _index_ into the output list of **t**.
